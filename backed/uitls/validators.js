...
// Note: email/password credentials are handled entirely by the Firebase
// Auth client SDK (createUserWithEmailAndPassword / signInWithEmailAndPassword
// / signInWithPopup for Google). The backend only ever sees a verified
// Firebase ID token, never a raw password, so these validators just cover
// the profile fields sent alongside that token.
